...
clean-Core-2f-cpp:
	-$(RM) ./Core/cpp/afficheur.cyclo ./Core/cpp/afficheur.d ./Core/cpp/afficheur.o ./Core/cpp/afficheur.su ./Core/cpp/main.cyclo ./Core/cpp/main.d ./Core/cpp/main.o ./Core/cpp/main.su ./Core/cpp/user.cyclo ./Core/cpp/user.d ./Core/cpp/user.o ./Core/cpp/user.su
